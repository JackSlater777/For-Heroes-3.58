...
namespace Era
{
  ...
  */
  ...
  /* WoG vars */
  __declspec(selectany) int*      v = (int*)      0x887664; // 1..10000
  __declspec(selectany) TErmZVar* z = (TErmZVar*) 0x9271E8; // 1..1000
  __declspec(selectany) int*      y = (int*)      0xA48D7C; // 1..100
  __declspec(selectany) int*      x = (int*)      0x91DA34; // 1..16
  __declspec(selectany) bool*     f = (bool*)     0x91F2DF; // 1..1000
  __declspec(selectany) float*    e = (float*)    0xA48F14; // 1..100
  ...
  typedef int   (__stdcall *TSetLanguage) (const char* NewLanguage);  // Changes current language code in memory without altering ini files or reloading already loaded data
  typedef void  (__stdcall *TReloadLanguageData) ();  // Reloads all json files from "Lang" directory and current language subdirectory.
  ...
  typedef bool  (__stdcall *TPcxPngExists) (const char* PcxName);
  ...
  __declspec(selectany) TEventParams* EventParams = NULL;

  __declspec(selectany) TApiHook              ApiHook               = NULL;
  __declspec(selectany) TClearAllIniCache     ClearAllIniCache      = NULL;
  __declspec(selectany) TClearIniCache        ClearIniCache         = NULL;
  __declspec(selectany) TExecErmCmd           ExecErmCmd            = NULL;
  __declspec(selectany) TExtractErm           ExtractErm            = NULL;
  __declspec(selectany) TFatalError           FatalError            = NULL;
  __declspec(selectany) TFireErmEvent         FireErmEvent          = NULL;
  __declspec(selectany) TFireEvent            FireEvent             = NULL;
  __declspec(selectany) TGetButtonID          GetButtonID           = NULL;
  __declspec(selectany) TGetEraVersion        GetEraVersion         = NULL;
  __declspec(selectany) TGetVersionNum        GetVersionNum         = NULL;
  __declspec(selectany) TGetGameState         GetGameState          = NULL;
  __declspec(selectany) TGetRealAddr          GetRealAddr           = NULL;
  __declspec(selectany) TGlobalRedirectFile   GlobalRedirectFile    = NULL;
  __declspec(selectany) THook                 Hook                  = NULL;
  __declspec(selectany) THookCode             HookCode              = NULL;
  __declspec(selectany) TLoadImageAsPcx16     LoadImageAsPcx16      = NULL;
  __declspec(selectany) TLoadTxt              LoadTxt               = NULL;
  __declspec(selectany) TMemFree              MemFree               = NULL;
  __declspec(selectany) TNameColor            NameColor             = NULL;
  __declspec(selectany) TNotifyError          NotifyError           = NULL;
  __declspec(selectany) TPatchExists          PatchExists           = NULL;
  __declspec(selectany) TPcxPngExists         PcxPngExists          = NULL;
  __declspec(selectany) TPluginExists         PluginExists          = NULL;
  __declspec(selectany) TReadSavegameSection  ReadSavegameSection   = NULL;
  __declspec(selectany) TReadStrFromIni       ReadStrFromIni        = NULL;
  __declspec(selectany) TRecallAPI            RecallAPI             = NULL;
  __declspec(selectany) TRedirectFile         RedirectFile          = NULL;
  __declspec(selectany) TRedirectMemoryBlock  RedirectMemoryBlock   = NULL;
  __declspec(selectany) TRegisterHandler      RegisterHandler       = NULL;
  __declspec(selectany) TReloadErm            ReloadErm             = NULL;
  __declspec(selectany) TReportPluginVersion  ReportPluginVersion   = NULL;
  __declspec(selectany) TRestoreEventParams   RestoreEventParams    = NULL;
  __declspec(selectany) TSaveEventParams      SaveEventParams       = NULL;
  __declspec(selectany) TSaveIni              SaveIni               = NULL;
  __declspec(selectany) TSplice               Splice                = NULL;
  __declspec(selectany) TToStaticStr          ToStaticStr           = NULL;
  __declspec(selectany) TTr                   _tr                   = NULL;
  __declspec(selectany) TWriteAtCode          WriteAtCode           = NULL;
  __declspec(selectany) TWriteSavegameSection WriteSavegameSection  = NULL;
  __declspec(selectany) TWriteStrToIni        WriteStrToIni         = NULL;
  __declspec(selectany) TGetDefaultMsgBoxItId GetDefaultMsgBoxItId  = NULL;
  __declspec(selectany) TGetMaskMsgBoxItId    GetMaskMsgBoxItId     = NULL;
  __declspec(selectany) TSetLanguage          SetLanguage           = NULL;
  __declspec(selectany) TReloadLanguageData   ReloadLanguageData    = NULL;
  ...
  __declspec(selectany) HINSTANCE hEra;
  __declspec(selectany) HINSTANCE hAngel;

  inline void ConnectEra ()
  {
    ...
    PcxPngExists          = (TPcxPngExists)         GetProcAddress(hEra, "PcxPngExists");
    ...
    SetLanguage           = (TSetLanguage)          GetProcAddress(hEra, "SetLanguage");
    ReloadLanguageData    = (TReloadLanguageData)   GetProcAddress(hEra, "ReloadLanguageData");
